...
if __name__ == '__main__':
    ...
    # build model
    model = Sequential()
    model.add(Bidirectional(GRU(32, return_sequences=True), input_shape=input_dim))
    ...
    scores_train = model.evaluate(X_text, X_label, verbose=1)
    scores_test = model.evaluate(X_text_test, Y_label, verbose=1)
