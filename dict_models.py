...
def test():
    ...
    tokens = lm_tokenizer.tokenize("trang shared post group mua online hà tĩnh trang gái lông rậm trai ngại đừng lo wax giải quyết vấn đề sạch bong lớp lông lá làn da mịn màng se khít lỗ chân lông viêm da lông mọc ngược tha hồ dơ đánh khẽ kết hợp bôi mỡ trăn giúp triệt lông vĩnh viễn inbox nha 0358618xxx")
    print(tokens)
